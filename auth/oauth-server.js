...
function createAuthConfig(envPrefix = 'MS_') {
  return {
    ...
    tokenEndpoint: process.env[`${envPrefix}TOKEN_ENDPOINT`] || `https://login.microsoftonline.com/${process.env.MS_TENANT_ID || 'common'}/oauth2/v2.0/token`,
    authEndpoint: process.env[`${envPrefix}AUTH_ENDPOINT`] || `https://login.microsoftonline.com/${process.env.MS_TENANT_ID || 'common'}/oauth2/v2.0/authorize`
  };
}
